 ...
 * Description: A simple command-line task manager that allows users to
 * add tasks, view tasks, mark tasks as completed or not completed,
 * remove tasks, and save/load tasks to a readable text file.
 * Skills demonstrated: Java basics, OOP, lists, loops, user input, file I/O.
 */
...
class Task {
    ...
    // Save-friendly string for file (readable)
    String saveString() {
        return display();
    }
...
public class TaskManager {
    ...
    // Load tasks from readable file safely
